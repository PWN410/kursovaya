...
<?php
echo '
<title>'.$array[5]["Name"].' - '.$array[5]["Author"].'</title>';
?>
	...
	<div class="dreamcrub">
                    ...
                    <li class="home">
                       ...
                       <span>&gt;</span>
                    	...
                    	<?php
                    	echo '
         <span class="red">&nbsp;'.$array[5]["Name"].'&nbsp;</span>';
         ?>
     </li>
                </ul>
                <ul class="previous">
...
<div class="content">
		<div class="features-section">
			<div class="features-section-head text-center">
				<h3><span>'.$array[5]["Name"].'</span> ('.$array[5]["Author"].')</h3>
				</div>
			</div>
		</div>
<div class="content">
<div class="box1">
				   ...
				   <div class="col_1_of_single1 span_1_of_single1">
				     <div class="view1 view-fifth1">
				  	  <div class="top_box">
				         <div class="grid_img">
						   <div class="css3"><a href = "haksli_o-divnyy-novyy-mir_kvunhq_470368.pdf"><img src="images/pic'.$array[5]["id"].'.jpg" alt=""/></a></div>
	                    </div>
	                    <h2>Просмотров: '.$array[5]["Views"].'</h2>
	                    </div>
	                    </div>
</div>
<div class="content">
...
<?php
for($i=0; $i<6;$i++){
	if($array[$i]["Category"]==$array[5]["Category"])
	{
	echo '
