...
<?php
echo '
<title>'.$array[2]["Name"].' - '.$array[2]["Author"].'</title>';
?>
	...
	<div class="dreamcrub">
                    ...
                    <li class="home">
                       ...
                       <span>&gt;</span>
                    	...
                    	<?php
                    	echo '
         <span class="red">&nbsp;'.$array[2]["Name"].'&nbsp;</span>';
         ?>
     </li>
                </ul>
                <ul class="previous">
...
<div class="content">
		<div class="features-section">
			<div class="features-section-head text-center">
				<h3><span>'.$array[2]["Name"].'</span> ('.$array[2]["Author"].')</h3>
				</div>
			</div>
		</div>
<div class="content">
				   ...
				   <div class="col_1_of_single1 span_1_of_single1">
				     <div class="view1 view-fifth1">
				  	  ...
				  	  <h3>Оценка: <span>'.$avr_rtng.'</span></h3>
				         ...
				         <div class="grid_img">
						   <div class="css3"><a href = "books/171987.a4.pdf"><img src="images/pic'.$array[2]["id"].'.jpg" alt=""/></a></div>
	                    </div>
	                    <div class="features-section-head text-center">
	                    ...
	                    <h3>Просмотров: <span>'.$array[2]["Views"].'</span></h3>
...
<?php
for($i=0; $i<6;$i++){
	if($array[$i]["Category"]==$array[2]["Category"])
	{
	echo '
